//! Session pins (R3): opt-in request header `x-blazar-session: <name>`
...
pub const SESSION_HEADER: &str = "x-blazar-session";
...
/// GET /api/sessions — live pins (observability: `blazar` tooling, live
