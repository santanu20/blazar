...
fn test_input<'a>(
    ...
    ProfileInput {
        ...
        meta: blazar_core::ModelMeta::Gguf(&META),
        hardware: hw,
        config: cfg,
        overlay,
        loras: &[],
