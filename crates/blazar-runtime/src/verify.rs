//! Post-pull integrity verification for `blazar pull --verify`.
//!
...
pub async fn verify_model(dirs: &BlazarDirs, name: &str) -> Result<VerifyReport> {
...
mod tests {
    ...
    fn sandbox() -> (tempfile::TempDir, BlazarDirs) {
