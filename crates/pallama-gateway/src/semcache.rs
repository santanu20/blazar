...
/// Header names (also advertised in `/.well-known/pallama`).
pub const HDR_CACHE: &str = "x-pallama-cache";
pub const HDR_CACHE_TTL: &str = "x-pallama-cache-ttl";
pub const HDR_CACHE_THRESHOLD: &str = "x-pallama-cache-threshold";
