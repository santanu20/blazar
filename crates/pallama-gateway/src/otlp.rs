...
//! crate family would dwarf pallama's gateway for a local-first server.
            ...
            "resourceSpans": [{
                "resource": {
                    "attributes": [
                        ...
                        {"key": "telemetry.sdk.name", "value": {"stringValue": "pallama-otlp"}},
                    ]
                },
                "scopeSpans": [{
                    "scope": {"name": "pallama-gateway"},
                    "spans": otlp_spans,
                }],
            }],
        })
...
mod tests {
    ...
    fn span(status: u16) -> OtlpSpan {
        OtlpSpan {
            ...
            http_status: status,
            attributes: vec![("pallama.trace_id".into(), "plm-x".into())],
        }
    }
